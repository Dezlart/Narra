  ...
  return (
    <footer className="mt-20 border-t border-border py-8">
      <div className="page-container flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p className="max-w-md text-sm leading-relaxed text-muted-foreground">Независимые голоса. Новые точки зрения.<br />Материалы главной страницы — демонстрационные.</p>
